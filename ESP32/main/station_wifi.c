                                ...
                                int32_t event_id, void* event_data)
{
    ...
    if ( event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_START) {
        ...
        //} else {
        	...
        	ESP_LOGE("WIFI_STATUS", "WYRZUCILO BŁĄD. Kod powodu: %d", disconnected->reason);
   ...
   s_retry_num=0;
    ...
    wifi_config_t wifi_config = {
        .sta = {
             ...
             */
        	.threshold.authmode = WIFI_AUTH_WPA2_PSK, // Ustaw konkretnie
    ...
    memcpy(wifi_config.sta.password,password->data,password->size+(password->size!=64));
